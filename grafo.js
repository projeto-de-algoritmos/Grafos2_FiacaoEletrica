...
// tentar implementar a versao otima do algoritmo de prim
  ...
  prim(inicial) {
    ...
    while(heap.fila_de_prioridades.length !== 0) {
      ...
      for(let vizinho of this.vertices[u]['vizinhos']) { // para cada vizinho de u
        ...
        if(typeof(vertices_explorados[vizinho['destino']]) === 'undefined' && vizinho['peso'] < heap.fila_de_prioridades[heap.estrutura_auxiliar[vizinho['destino']]['posicao']]['custo']) {
